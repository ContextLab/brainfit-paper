...
\begin{itemize}
\item 160 total (recruited ``master'' workers who reported owning and
  using a Fitbit device)
  \item 113 completed all experiments successfully.  We excluded the
    remaining participants who failed to log in to their Fitbit
    accounts, encountered technical issues that prevented them from
    participating in the study, or ended their participation before
    finishing the study.
  \item compensation (check this)
  \item M/F counts
  \item age
    \item demographics (race, education completed, location)
  \end{itemize}
\subsubsection*{Tasks}
