...
exploratory correlation analyses) to generate $N = 10,000$ bootstrapped
...
fitness-related, or demographic-related.  We examined whether
fitness-related and demographic-related features could be used to predict
performance on one or more of the memory tasks.
...
together, this yielded a set of $10,000$ observed RMSD values and $10,000$
...
distributions of weights, for each combination of features.
