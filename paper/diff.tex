...
%DIF DEL old.tex    Sat Jul 16 15:43:49 2022
%DIF ADD main.tex   Sat Jul 16 19:34:13 2022
...
\DIFaddendFL \caption{\DIFdelbeginFL \textbf{\DIFdelFL{Memory performance differs according to mental health
    measures.}}  %DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Summaries of correlations between behavioral, fitness, and mental
 health measures.}}  \DIFaddendFL The reported values in the \DIFdelbeginFL \DIFdelFL{table }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{tables }\DIFaddendFL reflect correlations
  ...
  \DIFaddbeginFL \textbf{\DIFaddFL{a. Correlations between behavioral and mental health measures.}}
  \DIFaddFL{We adjusted each task's behavioral measure(s) such that more positive values reflect
  better performance on the given task.  }\DIFaddendFL We used participants' mean recall accuracy to characterize
  ...
  Figs.~\ref{fig:immediate_behavior}, \ref{fig:delayed_behavior},\DIFaddbeginFL \DIFaddFL{~}\DIFaddendFL \frDetail,\DIFaddbeginFL \DIFaddFL{~}\DIFaddendFL \natDetail,\DIFaddbeginFL \DIFaddFL{~}\DIFaddendFL \vocabDetail, and\DIFaddbeginFL \DIFaddFL{~}\DIFaddendFL \spatialDetail).  \DIFaddbeginFL \DIFaddFL{For each mental health
  measure, more positive values denote greater severity of the given measure.  }\DIFaddendFL Typical
  ...
  self-reported medications \DIFaddbeginFL \DIFaddFL{(see }\textit{\DIFaddFL{Methods}}\DIFaddFL{).  Positive correlations indicate that
  better performance on a given behavioral task is associated with more severe 
  mental health phenotypes.  }\textbf{\DIFaddFL{b. Correlations between fitness
  and mental health measures.}}  \DIFaddFL{For each fitness measure, more positive
  ...
  }\textbf{\DIFaddFL{c. Correlations between fitness and behavioral measures.}}
  \DIFaddFL{Each measure reflected in this panel was treated as in Panels a and b}\DIFaddendFL .}
...
memory (Figs.~\DIFdelbegin \DIFdel{\ref{fig:mh_corr}}\DIFdelend \DIFaddbegin \DIFadd{\ref{fig:corr_summaries}}\DIFaddend , \allCorr).  For example, self-reported stress levels at the time of test
...
\DIFdelbegin %DIFDELCMD < \bibliography{/Users/jmanning/CDL-bibliography/cdl}
%DIFDELCMD <  %%%
