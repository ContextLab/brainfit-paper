...
%DIF DEL old.tex    Mon Jul 18 16:57:33 2022
%DIF ADD main.tex   Mon Jul 18 16:57:00 2022
...
\paragraph{Languages.}
All participants reported that they were fluent in either 1 \DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{or }\DIFaddend 2
...
random (with replacement across trials), and the \DIFdelbegin \DIFdel{order }\DIFdelend \DIFaddbegin \DIFadd{orders }\DIFaddend in which the
choices appeared to the participant were also randomized.  Each of the
10 words they had learned \DIFdelbegin \DIFdel{were }\DIFdelend \DIFaddbegin \DIFadd{was }\DIFaddend tested exactly once.
...
from each of four memory tasks \DIFaddbegin \DIFadd{(Fig.~\ref{fig:tasks})}\DIFaddend : a random word list learning ``free
recall'' task\DIFdelbegin \DIFdel{(Fig.~\ref{fig:tasks})}\DIFdelend ; a naturalistic recall task whereby participants watched
...
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Summaries of correlations between behavioral,
  ...
  \DIFdelbeginFL \DIFdelFL{table }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{tables }\DIFaddendFL reflect correlations between each \DIFdelbeginFL \DIFdelFL{behavioral measure and mental health measure}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{pair of measures}\DIFaddendFL .  Only statistically reliable correlations
  ($p < 0.05$, corrected) are displayed.  \DIFaddbeginFL \textbf{\DIFaddFL{a. Correlations
    between behavioral and mental health measures.}}  \DIFaddFL{We adjusted each
  task's behavioral measure(s) such that more positive values reflect
  better performance on the given task.  }\DIFaddendFL We used participants' mean
  recall \DIFdelbeginFL \DIFdelFL{accuracy }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{accuracies }\DIFaddendFL to characterize performance on the free recall and
  foreign language flashcards tasks, and mean \DIFdelbeginFL \DIFdelFL{precision }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{precisions }\DIFaddendFL to
  ...
  regressions on mean estimation errors as a function of the \DIFdelbeginFL \DIFdelFL{number }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{numbers }\DIFaddendFL of
  ...
  self-reported medications \DIFaddbeginFL \DIFaddFL{(see }\textit{\DIFaddFL{Methods}}\DIFaddFL{).  Positive
...
(\DIFaddbegin \DIFadd{Fig.~\ref{fig:corr_summaries}; }\DIFaddend for a complete report, see Fig.~\allCorr).
...
performance ($r =
0.48, p = 0.003$) and immediate recall }\DIFdelend \DIFaddbegin \DIFadd{sedentary
(``out-of-range'') cardiovascular activity was negatively correlated
with }\DIFaddend performance on the \DIFdelbegin \DIFdel{foreign language
flashcards task
($r = 0.43, p = 0.048$).  Recent high-intensity
}\DIFdelend \DIFaddbegin \DIFadd{spatial learning task
($r = -0.31, p = 0.042$), whereas recent high intensity }\DIFaddend (``peak'')
...
\caption{\DIFdelbeginFL \textbf{\DIFdelFL{Dynamics of physical activity varies with memory
    performance and mental health measures.}}  %DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Dynamics of physical activity vary with memory
    performance and mental health measures.}}  \DIFaddendFL \textbf{a. Daily step counts.}  Each
...
correlations and associations, rather than to imply knowledge about \DIFdelbegin \DIFdel{a causal direction
}\DIFdelend \DIFaddbegin \DIFadd{causal directions
}\DIFaddend of our findings.
...
\DIFdelbegin %DIFDELCMD < \bibliography{/home/jeremy/CDL-bibliography/cdl}
%DIFDELCMD <  %%%
\DIFdelend \DIFaddbegin \bibliography{/home/jeremy/CDL-bibliography/cdl.bib}
